...
--
-- Name: tb_department; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: tb_department_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: tb_department_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.tb_department_id_seq OWNED BY public.tb_department.id;
...
--
-- Name: tb_product_cetegory; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.tb_product_cetegory (
    product_id bigint NOT NULL,
...
--
-- Name: tb_department id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_department ALTER COLUMN id SET DEFAULT nextval('public.tb_department_id_seq'::regclass);
...
--
-- Name: tb_department tb_department_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_department
    ADD CONSTRAINT tb_department_pkey PRIMARY KEY (id);
...
--
-- Name: tb_product_cetegory tb_product_cetegory_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_product_cetegory
    ADD CONSTRAINT tb_product_cetegory_pkey PRIMARY KEY (product_id, category_id);
...
--
-- Name: tb_product_cetegory fk2o7h4kb2awag8n8lsfntejilf; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_product_cetegory
    ADD CONSTRAINT fk2o7h4kb2awag8n8lsfntejilf FOREIGN KEY (product_id) REFERENCES public.tb_product(id);
...
--
-- Name: tb_product_cetegory fknfkx2frs6ceio7o8cwqq7nwud; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_product_cetegory
    ADD CONSTRAINT fknfkx2frs6ceio7o8cwqq7nwud FOREIGN KEY (category_id) REFERENCES public.tb_category(id);
